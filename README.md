...
## Презентация и исследования
Мы не смогли прикрепить на платформу наши презентацию, поэтому ссылку на неё отсавляем тут:
https://disk.360.yandex.ru/i/j2c98mCab9eA2w

*Мы будем благодарны, если вы её так же посмотрите и отнесетесь с пониманием к данной ситуации*
