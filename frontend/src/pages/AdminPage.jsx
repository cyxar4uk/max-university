...
const AdminPage = () => {
  ...
  return (
    <div className="page">
      ...
      <div style={{ marginBottom: '24px' }}>
        <h2 style={{ marginBottom: '16px', fontSize: '18px' }}>Заявления абитуриентов</h2>
        <div className="card card-clickable" onClick={() => navigate('/admin/applications')}>
          <h3 className="card-title">📋 Проверка заявлений</h3>
          <p className="card-text">Проверка и обработка заявлений на поступление</p>
        </div>
      </div>
